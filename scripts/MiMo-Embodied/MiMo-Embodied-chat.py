...
MIMO_MAX_NEW_TOKENS_BASE = int(os.environ.get("EMBODIED_MIMO_FULLFLOW_MAX_NEW_TOKENS_BASE", "1024"))
MIMO_MAX_NEW_TOKENS_THINK = int(os.environ.get("EMBODIED_MIMO_FULLFLOW_MAX_NEW_TOKENS_THINK", "3072"))
MIMO_RETRY_MAX_NEW_TOKENS = int(os.environ.get("EMBODIED_MIMO_FULLFLOW_RETRY_MAX_NEW_TOKENS", "3072"))
MIMO_REPETITION_PENALTY = float(os.environ.get("EMBODIED_MIMO_FULLFLOW_REPETITION_PENALTY", "1.03"))
...
def normalize_first_fullflow_response(text: str) -> str:
    if not text:
        return ""
...
class MiMoEmbodiedInference:
    ...
    def _build_effective_prompt(self, prompt_text: str) -> str:
        ...
        return effective_prompt + FULLFLOW_GUIDANCE
    ...
    def _parse_candidate(self, raw_output: str):
        ...
        cleaned_output = normalize_first_fullflow_response(raw_output)
...
def main():
    ...
    parser.add_argument(
        ...
        "-m",
        type=str,
        default=str(PROJECT_ROOT / "MiMo-Embodied" / "MiMo-Embodied-7B-hf"),

#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Prompt construction helpers for the experiment pipeline."""
...
def load_video_descriptions_from_xlsx(_: str) -> Dict[str, str]:
    """Deprecated compatibility shim."""
    raise ValueError("XLSX detail prompt files are deprecated. Please use CSV.")
...
def build_prompt(
    ...
    """Build the final prompt for one question."""
